  ...
  <div className="pt-24">
    <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
        <h1 className="my-4 text-5xl font-bold leading-tight mx-auto lg:mx-0">
          {siteTitle}
        </h1>
        <p className="leading-normal text-2xl mb-8 mx-auto lg:mx-0">
          {siteBajada}
        </p>
      ...
      <div className="w-full md:w-3/5 py-6 text-center">
        <svg
          ...
          />
          <circle cx={450.004} cy={233.746} r={3} fill="#6c63ff" />
          <circle cx={333.004} cy={233.746} r={3} fill="#6c63ff" />
          ...
          <circle cx={773.004} cy={266.746} r={3} fill="#6c63ff" />
